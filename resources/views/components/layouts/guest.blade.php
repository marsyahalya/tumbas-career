...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $title ?? 'Authentikasi' }} | {{ config('app.name', 'Tumbas Coffee') }}</title>
    ...
    <body class="font-sans text-gray-900 antialiased bg-stone-50 relative overflow-hidden">
        ...
        <div class="absolute top-1/2 -right-20 w-80 h-80 bg-tumbas/10 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 relative z-10">
            ...
            <div class="w-full sm:max-w-md mt-6 px-8 py-8 bg-white shadow-xl border border-stone-100 overflow-hidden sm:rounded-2xl relative">
                <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-tumbas to-tumbas-light"></div>
