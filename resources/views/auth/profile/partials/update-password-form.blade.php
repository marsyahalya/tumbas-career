<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-forms.input-label for="update_password_current_password" :value="__('Kata Sandi Saat Ini')" />
        ...
        <div>
            <x-forms.input-label for="update_password_password" :value="__('Kata Sandi Baru')" />
        ...
        <div>
            <x-forms.input-label for="update_password_password_confirmation" :value="__('Konfirmasi Kata Sandi')" />
