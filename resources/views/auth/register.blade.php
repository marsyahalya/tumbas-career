<x-layouts.guest title="Daftar Riders">
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-forms.input-label for="password_confirmation" :value="__('Konfirmasi Kata Sandi')" />
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-tumbas-light" href="{{ route('login') }}">
                {{ __('Sudah punya akun?') }}
            </a>
